...
```powershell
python3 .repers/scripts\repers.py init --task "basic task"
python3 .repers/scripts\repers.py preflight --query "basic task workflow" --refresh --json
python3 .repers/scripts\repers.py plan --task basic_task --json
python3 .repers/scripts\repers.py run --task basic_task --action dry-run --json
python3 .repers/scripts\repers.py bundle-status --json
```
