...
- Generated: `2026-06-21T14:49:34.323729+00:00`
- Remote name: `origin`
...
```powershell
python .repers/scripts/repers.py publish-handoff --remote-name origin --remote-url https://example.invalid/repers.git --base-branch main --pr-title "Add RePERS repository state report" --json
```
...
```powershell
gh pr create --draft --base main --head codex/repers-initial-package --title "Add RePERS repository state report" --body-file C:\Users\Administrator\Documents\RePERS\dist\repers-publish-handoff.md
```
